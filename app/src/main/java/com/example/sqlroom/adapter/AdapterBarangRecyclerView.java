...
import com.example.sqlroom.RoomCreateActivity;
import com.example.sqlroom.data.factory.AppDatabase;
...
public class AdapterBarangRecyclerView  extends
    ...
    public AdapterBarangRecyclerView(ArrayList<Barang> barangs, Context
        ...
        context = ctx;
        db = Room.databaseBuilder(context.getApplicationContext(), AppDatabase.class, "barangdb").allowMainThreadQueries().build();
    }
